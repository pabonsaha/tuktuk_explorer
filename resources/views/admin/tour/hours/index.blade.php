    ...
    <div x-data="{ isModalOpen: {{ $errors->any() ? 'true' : 'false' }}, isEditModalOpen:false } ">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between items-center">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Hour List for - {{$tour->title}}</h3>
                <button
            ...
            <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="custom-scrollbar max-w-full overflow-x-auto overflow-y-visible px-5 sm:px-6">
                        <table class="min-w-full text-left text-sm">
                            ...
                            <tr>
                                ...
                                <th class="px-5 py-3 font-medium text-gray-600 dark:text-gray-400">No of People</th>
                            ...
                            @forelse ($hours as $hour)
                                <tr>
                                    ...
                                    <td class="px-5 py-3 whitespace-nowrap sm:px-6">
                                        @if ($hour->thumbnail)
                                            <img src="{{ getFilePath($hour->thumbnail) }}" alt="hour Image"
                                    ...
                                    <td class="px-5 py-3 whitespace-nowrap sm:px-6 text-center">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <form action="{{route('admin.tour.hour.delete',[$tour->id,$hour->id])}}"
                    ...
                    <div class="border-t border-gray-200 px-6 py-4 dark:border-gray-800">
                        {{ $hours->links('admin.vendor.pagination.tailadmin') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        >
            ...
            >
                ...
                <form method="POST" action="{{ route('admin.tour.hour.store',$tour->id) }}"
                      enctype="multipart/form-data">
                    @csrf

                    <h4 class="mb-6 text-lg font-medium text-gray-800 dark:text-white/90">Add New Hour</h4>
        ...
        >
            ...
            >
                ...
                <form id="editHourForm" method="POST" enctype="multipart/form-data">
                    ...
                    <h4 class="mb-6 text-lg font-medium text-gray-800 dark:text-white/90">Edit Hour</h4>
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
                        ...
                        <!-- Thumbnail -->
                        <div class="col-span-2">
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Thumbnail</label>
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Number of
                                People</label>
                            <input type="number" name="number_of_people" id="edit_number_of_people"
                                   class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                        </div>
        ...
        <script type="module">
            $(function () {
                ...
                $(document).on('click', '.edit-btn', function () {
                    ...
                    $.ajax({
                        url: `/admin/tour/{{$tour->id}}}/hour/${id}/edit`,
                        type: 'GET',
                        success: function (res) {
                            ...
                            $('#edit_number_of_people').val(res.number_of_people);
                            $('#editHourForm').attr('action', `/admin/tour/{{$tour->id}}}/hour/${id}/update`);
                        },
                        error: function (xhr) {
                            console.error(xhr);
