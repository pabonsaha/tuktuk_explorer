            ...
            <div class="grid lg:grid-cols-2 gap-8">
                        ...
                        <div>
                                            ...
                                            <div x-show="currentView=='priceView'">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-xs text-gray-500 text-sm">from €<span
                                                                x-text="selectedhour?.price?getPerPassengerPrice():{{$tour->starting_price}}"></span> per person
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <div class="space-y-3">
                                                            <div class="flex items-center justify-between">
                                                                <label
                                                                    class="block text-sm font-semibold text-gray-800">Select
                                                                    Date</label>
                                                                <span class="text-xs font-bold bg-orange-600"
                                                                      x-show="selectedDate"
                                                            ...
                                                            <!-- Calendar Component -->
                                                            <div
                                                                class="bg-white border rounded-xl p-4 shadow-sm select-none">
                                                                <!-- Calendar Header -->
                                                                <div class="flex items-center justify-between mb-4">
                                                                    ...
                                                                    <button type="button" @click="nextMonth()"
                                                                            class="p-2 hover:bg-gray-100 rounded-full transition duration-150">
                                                                        <svg class="w-5 h-5 text-gray-600" fill="none"
                                                                             stroke="currentColor" viewBox="0 0 24 24">
                                                                            <path stroke-linecap="round"
                                                                                  stroke-linejoin="round"
                                                                ...
                                                                <div class="grid grid-cols-7 gap-1 mb-2">
                                                                    <template x-for="day in dayNames" :key="day">
                                                                        <div
                                                                            class="text-center text-xs font-semibold text-gray-400 uppercase tracking-wider"
                                                                            x-text="day"></div>
                                                                    </template>
                                                                </div>
                                                        ...
                                                        <div x-show="selectedDate" class="pt-4 mt-2" x-transition>
                                                            <label
                                                                class="block text-sm font-semibold text-gray-800 mb-3">Available
                                                                Times</label>
                                                        ...
                                                        <div x-show="selectedDate && selectedTime" x-transition
                                                            ...
                                                            <div
                                                                class="w-10 h-10 rounded-full bg-white border border-orange-200 flex items-center justify-center flex-shrink-0 shadow-sm">
                                                                <svg class="w-5 h-5 bg-orange-600" fill="none"
                                                            ...
                                                            <div>
                                                                <p class="font-bold bg-orange-800 mb-0.5">Tour
                                                                    Schedule</p>
                                                                <p><span x-text="formatDate(selectedDate)"></span> at
                                                                    <span class="font-semibold bg-orange-600"
                                                ...
                                                <div class="space-y-2 mt-3" x-show="priceFormErrors.length>0">
                                                    <template x-for="error in priceFormErrors">
                                                        <p
                                                            class="px-3 py-2 bg-red-50 border border-red-200 rounded-lg text-sm font-medium flex items-center gap-2">
                                                ...
                                                <button @click="submitPriceForm()"
                                                    ...
                                                    <span class="flex items-center gap-2 font-medium">Continue <svg
                                                            class="w-5 h-5" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24"><path stroke-linecap="round"
                                                                                      stroke-linejoin="round"
                                                                                      stroke-width="2"
                                                                                      d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg></span>
                                                </button>
                                            </div>
                                                ...
                                                <div class="space-y-5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            :class="personalInformationError.phone ? 'border-b-orange-500 focus:ring-orange-500 focus:border-orange-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'"
                                                            class="w-full border rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 transition duration-150 focus:ring-2 focus:outline-none"
                                                    ...
                                                    <div class="space-y-4 pt-2">
                                                        <label class="flex items-start gap-3 cursor-pointer group">
                                                            <input
                                                                ...
                                                                class="w-4 h-4 mt-0.5 rounded border-gray-300 bg-orange-600 focus:ring-2 focus:ring-orange-500 cursor-pointer"
                                                            />
                            ...
                            I agree to the <a class="text-blue-600 hover:text-blue-700 underline font-medium" href="#">cancellation terms</a> <span
                                                    ...
                                                    <template x-for="addition in additionals">
                                                            ...
                                                            <div class="text-sm font-semibold text-orange-700 m-0">
               ...
               disabled:bg-gray-400 disabled:cursor-not-allowed">
                                                            ...
                                                            <span class="flex justify-center items-center gap-2">
                                                                ...
                                                                <span
                                                                    x-text="isSubmitting ? 'Processing...' : 'Pay →'"></span>
                                                            </span>
                                                        </button>
                                                    </div>
            ...
            return {
                ...
                submitPersonalInfoFrom(type) {
                    if (this.validateField('fullName') && this.validateEmail() && this.validateField('country') && this.validatePhone('phone') && this.validateAgreement('termsCancellation') && this.validateAgreement('termsBooking')) {
                        ...
                        const endpoint = type === 'stripe' ? '{{ route('tour.booking') }}' : '{{ route('tour.bookingWithoutPayment') }}';
                        fetch(endpoint, {
                            method: 'POST',
                            headers: {
